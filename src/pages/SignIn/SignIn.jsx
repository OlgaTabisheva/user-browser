...
import {tokenFetched, setErrorToken} from "../../store/slices/tokenSlice";
  ...
  return (
    <div className='sign-up'>
      <form onSubmit={signIn} className='sign-up__form'>
        ...
        <input className='sign-up__input' value={formValuesSignIn.email} onChange={handleInputChange} placeholder='example@mail.ru' type="text" id="email" ></input>
        ...
        <div className="sign-up__input-box">
          <input className='sign-up__input' value={formValuesSignIn.password} onChange={handleInputChange} placeholder='******' type={type ? "password" : "text"} id="password" ></input>
